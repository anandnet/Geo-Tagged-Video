...
var geolocator = Geolocator();
  ...
  void initState() {
    ...
    controller.initialize().then((_) {
      geolocator.getCurrentPosition(locationPermissionLevel:GeolocationPermission.locationAlways);
      if (!mounted) {
        return;
      }
      setState(() {});
  ...
  void didChangeDependencies() {
    print(geolocator.getCurrentPosition(locationPermissionLevel:GeolocationPermission.locationAlways));
...
Map<String,Position> _mapData={};    
Future<Void> getloctaion(String time)async{
  print("called");
  Position position = await geolocator.getCurrentPosition(desiredAccuracy: LocationAccuracy.high);
  print("${position.timestamp},$position");
  _mapData[time]=position;
  Fluttertoast.showToast(
        msg: '$position',
